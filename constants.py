...
eps = .01 ## sets the charge to mass ratio (size 1/eps), and the initial loop radius (eps)
total_t = 9000
dt = eps/5
...
theta_sep = 2*3.14159/num_part ## initial angular separation between adjacent particles
